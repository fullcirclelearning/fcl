  ...
  return (
    <>
          <div class="flex justify-center mt-20">
            <img width="691" height="194" alt="Educators consulting around a table" src="src/media/peopleAroundTable.jpg" />
          </div>
          <div class="flex justify-center mt-20">
          ...
          <div class=" hidden flex flex-col w-full mx-60  justify-center mt-20">
            <p class="flex-wrap">Education typically focuses on what to learn or how to learn. Full-Circle Learning also emphasizes why to learn.</p>
            <p class="flex-wrap">This research-based model of education cultivates the instinct to connect and to create, to balance curiosity with compassion, to problem-solve with humanitarian intent, to improve social cohesion, motivation and behavior.</p>
